...
* @{
*/
#define PRODUCT_KEY "c48ad0a40b0145dcb2d06743ac884c19"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "6ac01fb6582b4f73b0ace858f374aff5"
...
#define accx_RATIO                         1
#define accx_ADDITION                      0
#define accx_MIN                           0
#define accx_MAX                           100
#define heart_RATIO                         1
#define heart_ADDITION                      0
#define heart_MIN                           0
#define heart_MAX                           200
#define spo2_RATIO                         1
#define spo2_ADDITION                      0
#define spo2_MIN                           0
#define spo2_MAX                           100
/**@} */
