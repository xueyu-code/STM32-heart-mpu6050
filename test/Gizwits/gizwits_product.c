...
void userHandle(void)
{
   ...
   currentDataPoint.valueaccx =aacx;//Add Sensor Data Collection
    currentDataPoint.valueheart =heart;//Add Sensor Data Collection
    currentDataPoint.valuespo2 =spo2;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      currentDataPoint.valueaccx = ;
      currentDataPoint.valueheart = ;
      currentDataPoint.valuespo2 = ;
    */
