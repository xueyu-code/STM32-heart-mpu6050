...
{
 /*
    currentDataPoint.valueaccx = ;//Add Sensor Data Collection
    currentDataPoint.valueheart = ;//Add Sensor Data Collection
    currentDataPoint.valuespo2 = ;//Add Sensor Data Collection
